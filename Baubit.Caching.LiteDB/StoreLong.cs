...
namespace Baubit.Caching.LiteDB
{
    ...
    public class StoreLong<TValue> : Store<long, TValue>
    {
        ...
        public StoreLong(string databasePath,
                         string collectionName,
                         long? minCap,
                         long? maxCap,
                         Func<long?, long?> nextIdFactory,
        ...
        /// <param name="nextIdFactory">Function to generate the next ID. Takes the last generated ID and returns the next ID.</param>
        /// <param name="loggerFactory">Logger factory for creating loggers.</param>
        public StoreLong(LiteDatabase database,
                         string collectionName,
                         long? minCap,
                         long? maxCap,
                         Func<long?, long?> nextIdFactory,
        ...
        /// <summary>
        /// Creates the default sequential ID factory for long IDs.
        /// </summary>
        private static Func<long?, long?> CreateDefaultNextIdFactory()
        {
            long nextId = 1;
